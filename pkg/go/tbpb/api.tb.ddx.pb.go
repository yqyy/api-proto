...
type PromotedURLData struct {
	...
	CouponRemainCount   string    `protobuf:"bytes,10,opt,name=coupon_remain_count,json=couponRemainCount,proto3" json:"coupon_remain_count,omitempty"`
...
func (x *PromotedURLData) GetCouponRemainCount() string {
	if x != nil {
		return x.CouponRemainCount
	}
	return ""
...
var file_api_tb_ddx_proto_rawDesc = []byte{
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x63, 0x6f, 0x75, 0x70, 0x6f, 0x6e, 0x52, 0x65,
