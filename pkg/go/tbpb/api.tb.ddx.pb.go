...
type PromotedURLData struct {
	...
	Coupon              int32     `protobuf:"varint,6,opt,name=coupon,proto3" json:"coupon,omitempty"`
...
func (x *PromotedURLData) GetCoupon() int32 {
	if x != nil {
		return x.Coupon
	}
	return 0
...
var file_api_tb_ddx_proto_rawDesc = []byte{
	...
	0x75, 0x70, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x63, 0x6f, 0x75, 0x70,
