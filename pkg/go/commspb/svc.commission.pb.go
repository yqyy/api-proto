...
func (x *UserBindOrderRes) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *UserBindPhoneRes) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
type UserDividendOrder struct {
	...
	OrderStatus     int64  `protobuf:"varint,3,opt,name=orderStatus,proto3" json:"orderStatus,omitempty"`        // 订单状态：-1 无效订单（未支付，退货，无佣金， 商家审核失败）1-有效但商家未结算订单（预估金额，用户可能退货）2-已结算订单（用户可提现）
	OrderVendor     int64  `protobuf:"varint,4,opt,name=orderVendor,proto3" json:"orderVendor,omitempty"`        // 订单Vendor
	PayStauts       int64  `protobuf:"varint,5,opt,name=payStauts,proto3" json:"payStauts,omitempty"`            // 支付状态： 0-未支付; 1-用户已提交提现申请，审核中; 2-审核未通过; 3-已审核通过，待支付处理中; 4-支付失败; 99-已支付;
	CashReqSN       string `protobuf:"bytes,6,opt,name=cashReqSN,proto3" json:"cashReqSN,omitempty"`             // 已支付的用户请求提现流水号
	Amount          int64  `protobuf:"varint,7,opt,name=amount,proto3" json:"amount,omitempty"`                  // 用户分配到的佣金额，单位为分
	OrderAmount     int64  `protobuf:"varint,8,opt,name=orderAmount,proto3" json:"orderAmount,omitempty"`        // 实际支付金额，单位为分
...
func (x *UserDividendOrder) GetOrderStatus() int64 {
	if x != nil {
...
func (x *UserDividendOrder) GetOrderVendor() int64 {
	if x != nil {
...
func (x *UserDividendOrder) GetPayStauts() int64 {
	if x != nil {
		return x.PayStauts
	}
	return 0
...
func (x *UserDividendOrder) GetAmount() int64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *UserDividendOrder) GetOrderAmount() int64 {
	if x != nil {
...
func (x *UserGetOrdersRes) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *UserQueryBalanceRes) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *UserDrawMoneyRes) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
type DrawMoneyRecords struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserID     string `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`
	ReqSN      string `protobuf:"bytes,2,opt,name=reqSN,proto3" json:"reqSN,omitempty"`
	OrderSNs   string `protobuf:"bytes,3,opt,name=orderSNs,proto3" json:"orderSNs,omitempty"`
	ReqAmount  int64  `protobuf:"varint,4,opt,name=reqAmount,proto3" json:"reqAmount,omitempty"`
	Status     int64  `protobuf:"varint,5,opt,name=status,proto3" json:"status,omitempty"`
	PaidAmount int64  `protobuf:"varint,6,opt,name=paidAmount,proto3" json:"paidAmount,omitempty"`
	PayMethod  int64  `protobuf:"varint,7,opt,name=payMethod,proto3" json:"payMethod,omitempty"`
}

func (x *DrawMoneyRecords) Reset() {
	*x = DrawMoneyRecords{}
	if protoimpl.UnsafeEnabled {
		mi := &file_svc_commission_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DrawMoneyRecords) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DrawMoneyRecords) ProtoMessage() {}

func (x *DrawMoneyRecords) ProtoReflect() protoreflect.Message {
	mi := &file_svc_commission_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DrawMoneyRecords.ProtoReflect.Descriptor instead.
func (*DrawMoneyRecords) Descriptor() ([]byte, []int) {
	return file_svc_commission_proto_rawDescGZIP(), []int{13}
}

func (x *DrawMoneyRecords) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *DrawMoneyRecords) GetReqSN() string {
	if x != nil {
		return x.ReqSN
	}
	return ""
...
func (x *DrawMoneyRecords) GetOrderSNs() string {
	if x != nil {
		return x.OrderSNs
	}
	return ""
...
func (x *DrawMoneyRecords) GetReqAmount() int64 {
	if x != nil {
		return x.ReqAmount
	}
	return 0
...
func (x *DrawMoneyRecords) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *DrawMoneyRecords) GetPaidAmount() int64 {
	if x != nil {
		return x.PaidAmount
	}
	return 0
...
func (x *DrawMoneyRecords) GetPayMethod() int64 {
	if x != nil {
		return x.PayMethod
	}
	return 0
...
type UserDrawMoneyRecordsReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UserDrawMoneyRecordsReq) Reset() {
	*x = UserDrawMoneyRecordsReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_svc_commission_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UserDrawMoneyRecordsReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserDrawMoneyRecordsReq) ProtoMessage() {}

func (x *UserDrawMoneyRecordsReq) ProtoReflect() protoreflect.Message {
	mi := &file_svc_commission_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserDrawMoneyRecordsReq.ProtoReflect.Descriptor instead.
func (*UserDrawMoneyRecordsReq) Descriptor() ([]byte, []int) {
	return file_svc_commission_proto_rawDescGZIP(), []int{14}
}

func (x *UserDrawMoneyRecordsReq) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
type UserDrawMoneyRecordsRes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Code int64               `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Msg  string              `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg,omitempty"`
	Data []*DrawMoneyRecords `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
}

func (x *UserDrawMoneyRecordsRes) Reset() {
	*x = UserDrawMoneyRecordsRes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_svc_commission_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UserDrawMoneyRecordsRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserDrawMoneyRecordsRes) ProtoMessage() {}

func (x *UserDrawMoneyRecordsRes) ProtoReflect() protoreflect.Message {
	mi := &file_svc_commission_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserDrawMoneyRecordsRes.ProtoReflect.Descriptor instead.
func (*UserDrawMoneyRecordsRes) Descriptor() ([]byte, []int) {
	return file_svc_commission_proto_rawDescGZIP(), []int{15}
}

func (x *UserDrawMoneyRecordsRes) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *UserDrawMoneyRecordsRes) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
func (x *UserDrawMoneyRecordsRes) GetData() []*DrawMoneyRecords {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_svc_commission_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x56, 0x65,
	0x6e, 0x64, 0x6f, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x61, 0x79, 0x53, 0x74,
	0x61, 0x75, 0x74, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x70, 0x61, 0x79, 0x53,
	...
	0x01, 0x28, 0x03, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03,
	...
	0x64, 0x65, 0x72, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0x2a, 0x0a, 0x10, 0x55,
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x66, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x44,
	0x72, 0x61, 0x77, 0x4d, 0x6f, 0x6e, 0x65, 0x79, 0x52, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x63,
	...
	,
	...
	,
...
var file_svc_commission_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_svc_commission_proto_goTypes = []interface{}{
	...
	(*DrawMoneyRecords)(nil),        // 13: commspb.DrawMoneyRecords
	(*UserDrawMoneyRecordsReq)(nil), // 14: commspb.UserDrawMoneyRecordsReq
	(*UserDrawMoneyRecordsRes)(nil), // 15: commspb.UserDrawMoneyRecordsRes
}
var file_svc_commission_proto_depIdxs = []int32{
	...
	13, // 4: commspb.UserDrawMoneyRecordsRes.data:type_name -> commspb.DrawMoneyRecords
	0,  // 5: commspb.CommissionService.UserBindOrder:input_type -> commspb.UserBindOrderReq
	2,  // 6: commspb.CommissionService.UserBindPhone:input_type -> commspb.UserBindPhoneReq
	5,  // 7: commspb.CommissionService.UserGetOrders:input_type -> commspb.UserGetOrdersReq
	8,  // 8: commspb.CommissionService.UserQueryBalance:input_type -> commspb.UserQueryBalanceReq
	11, // 9: commspb.CommissionService.UserWithdrawMoney:input_type -> commspb.UserDrawMoneyReq
	14, // 10: commspb.CommissionService.UserQueryDrawMoneyRecords:input_type -> commspb.UserDrawMoneyRecordsReq
	1,  // 11: commspb.CommissionService.UserBindOrder:output_type -> commspb.UserBindOrderRes
	3,  // 12: commspb.CommissionService.UserBindPhone:output_type -> commspb.UserBindPhoneRes
	6,  // 13: commspb.CommissionService.UserGetOrders:output_type -> commspb.UserGetOrdersRes
	9,  // 14: commspb.CommissionService.UserQueryBalance:output_type -> commspb.UserQueryBalanceRes
	12, // 15: commspb.CommissionService.UserWithdrawMoney:output_type -> commspb.UserDrawMoneyRes
	15, // 16: commspb.CommissionService.UserQueryDrawMoneyRecords:output_type -> commspb.UserDrawMoneyRecordsRes
...
func file_svc_commission_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_svc_commission_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DrawMoneyRecords); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_svc_commission_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserDrawMoneyRecordsReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_svc_commission_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserDrawMoneyRecordsRes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
