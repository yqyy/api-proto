...
type AuthorityQueryData struct {
	...
	Bind int64 `protobuf:"varint,1,opt,name=bind,proto3" json:"bind,omitempty"` // 1-已绑定；0-未绑定
}
...
func (x *AuthorityQueryData) GetBind() int64 {
	if x != nil {
		return x.Bind
	}
	return 0
...
func (x *AuthorityQueryResponse) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
type CreateMarketingURLRequest struct {
	...
	ChannelType       int64   `protobuf:"varint,7,opt,name=channel_type,json=channelType,proto3" json:"channel_type,omitempty"`                           // 营销工具类型，必填：-1-活动列表，0-红包(需申请推广权限)，2–新人红包，3-刮刮卡，5-员工内购，6-购物车，10-生成绑定备案链接，12-砸金蛋，13-一元购，14-千万补贴B端页面，15-充值中心B端页面
...
func (x *CreateMarketingURLRequest) GetChannelType() int64 {
	if x != nil {
...
func (x *CreateMarketingURLResponse) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *URLConvertResponse) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
type SearchData struct {
	...
	MallCouponDiscountPct       int64    `protobuf:"varint,3,opt,name=mall_coupon_discount_pct,json=mallCouponDiscountPct,proto3" json:"mall_coupon_discount_pct,omitempty"`                     // 店铺券折扣
	MallCouponMinOrderAmount    int64    `protobuf:"varint,4,opt,name=mall_coupon_min_order_amount,json=mallCouponMinOrderAmount,proto3" json:"mall_coupon_min_order_amount,omitempty"`          // 最小使用金额
	MallCouponMaxDiscountAmount int64    `protobuf:"varint,5,opt,name=mall_coupon_max_discount_amount,json=mallCouponMaxDiscountAmount,proto3" json:"mall_coupon_max_discount_amount,omitempty"` // 最大使用金额
	...
	MerchantType                int64    `protobuf:"varint,19,opt,name=merchant_type,json=merchantType,proto3" json:"merchant_type,omitempty"`                                                   // 店铺类型，1-个人，2-企业，3-旗舰店，4-专卖店，5-专营店，6-普通店（未传为全部)
	...
	MallCps                     int64    `protobuf:"varint,26,opt,name=mall_cps,json=mallCps,proto3" json:"mall_cps,omitempty"`                                                                  // 该商品所在店铺是否参与全店推广，0：否，1：是
	...
	PlanType                    int64    `protobuf:"varint,47,opt,name=plan_type,json=planType,proto3" json:"plan_type,omitempty"`                                                               // 推广计划类型 3:定向 4:招商
...
func (x *SearchData) GetMallCouponDiscountPct() int64 {
	if x != nil {
...
func (x *SearchData) GetMallCouponMinOrderAmount() int64 {
	if x != nil {
...
func (x *SearchData) GetMallCouponMaxDiscountAmount() int64 {
	if x != nil {
...
func (x *SearchData) GetMerchantType() int64 {
	if x != nil {
...
func (x *SearchData) GetMallCps() int64 {
	if x != nil {
		return x.MallCps
	}
	return 0
...
func (x *SearchData) GetActivityType() int64 {
	if x != nil {
...
func (x *SearchData) GetPlanType() int64 {
	if x != nil {
		return x.PlanType
	}
	return 0
...
type SearchRequest struct {
	...
	Page             *int64   `protobuf:"varint,3,opt,name=page,proto3,oneof" json:"page,omitempty"`                                                     // 默认值1，商品分页数
	PageSize         *int64   `protobuf:"varint,4,opt,name=page_size,json=pageSize,proto3,oneof" json:"page_size,omitempty"`                             // 默认100，每页商品数量
	SortType         *int64   `protobuf:"varint,5,opt,name=sort_type,json=sortType,proto3,oneof" json:"sort_type,omitempty"`                             // 排序方式:0-综合排序;1-按佣金比率升序;2-按佣金比例降序;3-按价格升序;4-按价格降序;5-按销量升序;6-按销量降序;7-优惠券金额排序升序;8-优惠券金额排序降序;9-券后价升序排序;10-券后价降序排序;11-按照加入多多进宝时间升序;12-按照加入多多进宝时间降序;13-按佣金金额升序排序;14-按佣金金额降序排序;15-店铺描述评分升序;16-店铺描述评分降序;17-店铺物流评分升序;18-店铺物流评分降序;19-店铺服务评分升序;20-店铺服务评分降序;27-描述评分击败同类店铺百分比升序，28-描述评分击败同类店铺百分比降序，29-物流评分击败同类店铺百分比升序，30-物流评分击败同类店铺百分比降序，31-服务评分击败同类店铺百分比升序，32-服务评分击败同类店铺百分比降序
	...
	MerchantType     *int64   `protobuf:"varint,9,opt,name=merchant_type,json=merchantType,proto3,oneof" json:"merchant_type,omitempty"`                 // 店铺类型，1-个人，2-企业，3-旗舰店，4-专卖店，5-专营店，6-普通店（未传为全部)
	...
	MerchantTypeList []int64  `protobuf:"varint,12,rep,packed,name=merchant_type_list,json=merchantTypeList,proto3" json:"merchant_type_list,omitempty"` // 店铺类型数组
	...
	ActivityTags     []int64  `protobuf:"varint,14,rep,packed,name=activity_tags,json=activityTags,proto3" json:"activity_tags,omitempty"`               // 商品活动标记数组，例：[4,7]，4-秒杀 7-百亿补贴 10143-每日必推等
	BlockCatPackages []int64  `protobuf:"varint,15,rep,packed,name=block_cat_packages,json=blockCatPackages,proto3" json:"block_cat_packages,omitempty"` // 屏蔽商品类目：1-拼多多小程序屏蔽类目;2-虚拟类目;3-医疗器械;4-处方药;5-非处方药
...
func (x *SearchRequest) GetSortType() int64 {
...
func (x *SearchRequest) GetMerchantType() int64 {
...
func (x *SearchRequest) GetMerchantTypeList() []int64 {
	if x != nil {
...
func (x *SearchRequest) GetActivityTags() []int64 {
	if x != nil {
...
func (x *SearchRequest) GetBlockCatPackages() []int64 {
	if x != nil {
...
type SearchResponse struct {
	...
	Code         int64         `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Msg          string        `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg,omitempty"`
	TotalResults int64         `protobuf:"varint,3,opt,name=total_results,json=totalResults,proto3" json:"total_results,omitempty"` // 返回商品总数
...
func (x *PromotionResponse) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_pdd_ddx_proto_rawDesc = []byte{
	...
	0x61, 0x12, 0x12, 0x0a, 0x04, 0x62, 0x69, 0x6e, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x54, 0x79, 0x70,
	...
	0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x99, 0x10, 0x0a, 0x0a, 0x53, 0x65, 0x61, 0x72,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x15, 0x6d, 0x61, 0x6c, 0x6c, 0x43, 0x6f, 0x75, 0x70,
	...
	0x01, 0x28, 0x03, 0x52, 0x18, 0x6d, 0x61, 0x6c, 0x6c, 0x43, 0x6f, 0x75, 0x70, 0x6f, 0x6e, 0x4d,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x1b, 0x6d, 0x61, 0x6c, 0x6c, 0x43, 0x6f, 0x75, 0x70,
	...
	0x79, 0x70, 0x65, 0x18, 0x13, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x6d, 0x65, 0x72, 0x63, 0x68,
	...
	0x01, 0x28, 0x03, 0x52, 0x07, 0x6d, 0x61, 0x6c, 0x6c, 0x43, 0x70, 0x73, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x54, 0x79,
	...
	0x65, 0x18, 0x2f, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x6c, 0x61, 0x6e, 0x54, 0x79, 0x70,
	...
	0x69, 0x67, 0x6e, 0x22, 0xb2, 0x06, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x65,
	...
	0x64, 0x88, 0x01, 0x01, 0x12, 0x1a, 0x0a, 0x06, 0x6f, 0x70, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x04, 0x48, 0x01, 0x52, 0x05, 0x6f, 0x70, 0x74, 0x49, 0x64, 0x88, 0x01, 0x01,
	...
	,
	...
	,
}
